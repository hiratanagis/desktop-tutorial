...
module.exports = {
    ...
    .setName("autoplay")
    .setDescription("Aktifkan atau Matikan Autoplay."),
    /**
     * 
    ...
    async execute(interaction, client) {
        ...
        return interaction.reply({embeds: [Response.setDescription(`🔁 Autoplay Mode telah diset ke: ${mode ? "ON" : "OFF"}`)], ephemeral: true})
    }
}